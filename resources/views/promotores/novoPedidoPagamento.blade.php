...
<div class="modal-body">
    <form id="novoPP_Form" action="{{ url('projecto/post_pedido_pagamento') }}" method="POST" accept-charset="utf-8" data-toggle="validator">
        ...
        <div class="row">
            <div class="form-group has-feedback col-md-6" id="toggle_data" style="display:none;">
            ...
            <div class="form-group has-feedback col-md-6" id="toggle_valor" style="display:none;">
