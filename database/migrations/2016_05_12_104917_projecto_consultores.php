...
class ProjectoConsultores extends Migration
{
    ...
    public function up()
    {
        Schema::create('projecto_consultores', function (Blueprint $table) {
            ...
            $table->smallInteger('consultoria');
            $table->double('valor_hora_consultoria');
            $table->smallInteger('numero_horas_consultoria');
            $table->double('total_consultoria');
            $table->smallInteger('formacao');
